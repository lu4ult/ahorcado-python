...
#Aveces la definición de la palabra incluye la palabra en sí, por eso la reemplazamos por asteriscos para evitar verla accidentalmente.
definicion = definicion.replace(palabra,'*' * len(palabra))
#Aveces la descripción trae un montón de otra información, como sinónimos o códigos HTML, asi que limitamos el largo de la respuesta.
definicion = definicion[:100]
